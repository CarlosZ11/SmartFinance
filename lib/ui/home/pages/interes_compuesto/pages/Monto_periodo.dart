...
static List<double> calcularMonto(double capital, double tasaInteres, double valorTiempo, String unidadTiempo) {
...
class PeriodoPage extends StatefulWidget {
  ...
  @override
  State<PeriodoPage> createState() => _PeriodoPage();
}
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Para hallar el Monto por Periodo se utiliza la siguiente formula: M\u2099 = C(1+i)\nDonde C es capital, i es tasa de interés y N son los Periodos",
                  style: GoogleFonts.saira(
                    fontSize: 15,
                    fontWeight: FontWeight.bold
                  ),
              ...
              Container(
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    ...
                    double montofinal= double.parse(capitalController.text);
                    ...
                    if(tiempoCompuesto){
                      ...
                      List<double> capital = PeriodoCalculator.calcularMonto(montofinal, tasaInteres, valorTiempo, unidadTiempo);
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          ...
                          //   ],
                          // );
                          return CustomAlertDialog(title: 'Resultado', content: 'Monto por Periodos: \$${capital.map((double value) => value.toStringAsFixed(0)).join(", ")}', capitalController: capitalController, tasaInteresController: tasaInteresController,);
                        },
                      );
