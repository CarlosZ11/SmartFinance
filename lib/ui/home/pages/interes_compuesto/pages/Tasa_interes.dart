...
class TasaInteresCalculator {
  ...
  static calcularTasainteres(double montofinal, double capital, double valorTiempo, String unidadTiempo) {
    final tiempo = calcularTiempo(valorTiempo, unidadTiempo);
    return pow(montofinal/capital, 1/tiempo) -1 ;
  }
}

class TasaInteresPage2 extends StatefulWidget {
  const TasaInteresPage2({super.key});

  @override
  State<TasaInteresPage2> createState() => _TasaInteresPageState();
}

class _TasaInteresPageState extends State<TasaInteresPage2> {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Para hallar la Tasa de Interes se utiliza la siguiente formula: Tasa de Interés (i) = (VF / C)^(1/N) - 1\nDonde C es capital, VF es Valor futuro o Monto final y N es tiempo",
                  style: GoogleFonts.saira(
                    fontSize: 15,
                    fontWeight: FontWeight.bold
                  ),
              ...
              InputTextFormField(labelText: "Monto Final", prefixIcon: Remix.exchange_funds_line, valueText: '', controller: valorfinalController,),
              InputTextFormField(labelText: "Capital", prefixIcon: Remix.discount_percent_fill, valueText: '', controller: capitalController,),
              ...
              Container(
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    if(valorfinalController.text.isEmpty || capitalController.text.isEmpty){
                      showDialog(
                        context: context,
                    ...
                    if(tiempoCompuesto){
                      ...
                      double tasainteres = TasaInteresCalculator.calcularTasainteres(montofinal, capital, valorTiempo, unidadTiempo);
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          ...
                          //   ],
                          // );
                          return CustomAlertDialog(title: 'Resultado', content: 'Tasa de interes: \$${tasainteres.toStringAsFixed(3)}', capitalController: capitalController, tasaInteresController: valorfinalController,);
                        },
                      );
