...
class CapitalCalculator {
  ...
  static double calcularCapital(double montofinal, double tasaInteres, double valorTiempo, String unidadTiempo) {
    final tiempo = calcularTiempo(valorTiempo, unidadTiempo);
    return montofinal / pow((1 + tasaInteres), tiempo);
  }
}

class CapitalPage2 extends StatefulWidget {
  const CapitalPage2({super.key});

  @override
  State<CapitalPage2> createState() => _CapitalPageState();
}

class _CapitalPageState extends State<CapitalPage2> {
            ...
            children: [
              ...
              Container(
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    if(valorfinalController.text.isEmpty || tasaInteresController.text.isEmpty){
                      showDialog(
                        context: context,
                    ...
                    if(tiempoCompuesto){
                      ...
                      double capital = CapitalCalculator.calcularCapital(montofinal, tasaInteres, valorTiempo, unidadTiempo);
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          ...
                          //   ],
                          // );
                          return CustomAlertDialog(title: 'Resultado', content: 'Capital: \$${capital.toStringAsFixed(2)}', capitalController: valorfinalController, tasaInteresController: tasaInteresController,);
                        },
                      );
