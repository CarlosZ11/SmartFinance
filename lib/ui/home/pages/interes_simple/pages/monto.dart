...
class MontoCalculator {
  ...
  static double calcularMontoFinal(double principal, double tasaInteres, double valorTiempo, String unidadTiempo) {
    ...
    return principal * (1 + tasaInteres * tiempoEnAnios);
  }
}

class MontoPage extends StatefulWidget {
  const MontoPage({super.key});

  @override
  State<MontoPage> createState() => _MontoPageState();
}
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    ...
                    if(tiempoCompuesto){
                      ...
                      valorTiempo = anios + (meses / 12) + (dias / 365);
                      ...
                      double montoFinal = MontoCalculator.calcularMontoFinal(principal, tasaInteres, valorTiempo, unidadTiempo);

                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                          return CustomAlertDialog(title: 'Resultado', content: 'Monto Final: \$${montoFinal.toStringAsFixed(2)}', capitalController: principalController, tasaInteresController: tasaInteresController,);
                        },
                      );
