...
class CompuestaCalculator {
  ...
  static double calcularCapitalizacionCompuesta(double principal, double tasaInteres, double valorTiempo, String unidadTiempo) {
    final tiempo = calcularTiempo(valorTiempo, unidadTiempo);
    return principal * pow(1 + tasaInteres, tiempo);
  }
}

class CapitalizacionCompuesta extends StatefulWidget {
  const CapitalizacionCompuesta({super.key});

  @override
  State<CapitalizacionCompuesta> createState() => _CapitalizacionCompuestaState();
}

class _CapitalizacionCompuestaState extends State<CapitalizacionCompuesta> {
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    ...
                    if(tiempoCompuesto){
                      ...
                      double montoFinal= CompuestaCalculator.calcularCapitalizacionCompuesta(capital, tasaInteres, valorTiempo, unidadTiempo);
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          ...
                          //   ],
                          // );
                          return CustomAlertDialog(title: 'Resultado', content: 'Monto Final: \$${montoFinal.toStringAsFixed(2)}', capitalController: capitalController, tasaInteresController: tasaInteresController,);
                        },
                      );
