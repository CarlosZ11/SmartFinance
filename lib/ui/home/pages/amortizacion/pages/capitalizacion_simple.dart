...
class SimpleCalculator {
  ...
  static double calcularCapitalizacionSimple(double principal, double tasaInteres, double valorTiempo, String unidadTiempo) {
    final tiempo = calcularTiempo(valorTiempo, unidadTiempo);
    return principal * tasaInteres * tiempo;
  }
}

class CapitalizacionSimple extends StatefulWidget {
  const CapitalizacionSimple({super.key});

  @override
  State<CapitalizacionSimple> createState() => _CapitalizacionSimpleState();
}

class _CapitalizacionSimpleState extends State<CapitalizacionSimple> {
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    ...
                    if(tiempoCompuesto){
                      ...
                      double montoFinal= SimpleCalculator.calcularCapitalizacionSimple(capital, tasaInteres, valorTiempo, unidadTiempo);
